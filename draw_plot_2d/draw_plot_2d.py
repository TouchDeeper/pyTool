...
plt.subplot(211)
legend_average_3, = plt.plot(generation_num_chromosomes, average_cost_chromosomes, color="green", linestyle="-", marker="o", linewidth=3)
plt.subplot(212)
legend_best_3, = plt.plot(generation_num_chromosomes, best_total_cost_chromosomes, color="green", linestyle="-", marker='o', linewidth=3)
