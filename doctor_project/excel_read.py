...
points_age, points_Troponin, points_NT_ProBNP, total_points = points_compute(stroke, age, Troponin, NT_proBNP)
...
pd_points_Troponin.to_excel(writer, sheet_name="Sheet1", startcol=32, index=False)
pd_points_NT_ProBNP.to_excel(writer, sheet_name="Sheet1", startcol=33, index=False)
writer.save()
